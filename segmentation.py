"""
 python3 main.py --train --batch_size 4 --optimizer sgd --data_augmentation standard --extractor pspresnet50 --filename example
Found 400 train images
    ...
    def run_test(self):
        ...
        with torch.no_grad():
            for imgs, labels, cls in test_loader:
                ...
                plt.savefig(str(counter)+'.png', format='png')
                plt.show()
